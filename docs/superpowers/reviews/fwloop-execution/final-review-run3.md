...
Key paths: `/var/home/alepar/AleCode/bazerame-fans/.claude/worktrees/fw-fanctrl-loop/.worktrees/epic-fw-fanctrl-loop-6ma-integration/` — `.superpowers/sdd/fw-fanctrl-loop-6ma-plan/progress.md`, `src/control/watchdog.rs:19`, `src/control/guards.rs:32`, `src/control/sim_tests.rs:2317`, `src/control/controller.rs:5701`, `Cargo.toml:15`.