...
next: super-code (phase 3), after user disposition of the low-coverage qualifier; not started in this session
stopReason: user explicitly required stopping after the extension report regardless of verdict; no further roast, implementation, merge, or hardware action
