...
## Your lens
Security lens. As warranted for a security or maintainability review of this spec. These two lenses widen
...
- **category:** `security` (required — this dispatch's lens)
