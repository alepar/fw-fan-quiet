...
## Input
DESIGN MODE. Spec: `/var/home/alepar/AleCode/bazerame-fans/.claude/worktrees/fw-fanctrl-loop/.worktrees/super-auto-per-device-temperature-loops/docs/superpowers/runs/2026-09-11-per-device-temperature-loops/2026-09-11-per-device-temperature-loops-design.md` (read it; its task tree is `/var/home/alepar/AleCode/bazerame-fans/.claude/worktrees/fw-fanctrl-loop/.worktrees/super-auto-per-device-temperature-loops/docs/superpowers/runs/2026-09-11-per-device-temperature-loops/task-tree-settled.md`). Shell discipline: absolute paths; `cd /var/home/alepar/AleCode/bazerame-fans/.claude/worktrees/fw-fanctrl-loop/.worktrees/super-auto-per-device-temperature-loops` as the first statement of every call; plain separate commands (this harness refuses compound constructs and heredocs that mention git as "too complex to verify" — a re-spell-and-retry, never a permission denial). Do NOT modify any file.
